...
import com.ppma.apktool.Apktool;
...
final public class AndrolibResources {
    ...
    public File getFrameworkDir() throws AndrolibException {
        ...
        if (apkOptions.frameworkFolderLocation != null) {
            ...
            File parentPath = Apktool.getHomeDir();
            path = parentPath.getAbsolutePath() + String.format("%1$sframework", File.separatorChar);
    ...
    public File getAndroidResourcesFile() throws AndrolibException {
        return new File(Apktool.getHomeDir(), "/brut/androlib/android-framework.jar");
    }
